...
extern int wrap_state;
extern char *wrap_name, wrap_module_name[];
...
void    write_state_header Argdcl((char**));
void    write_user_header(Void);
void    write_state_source Argdcl((char**));
void    write_interface_header(Void);
void    write_interface_source Argdcl((char**));
void    unlink_intermediate_files Argdcl((char**));
